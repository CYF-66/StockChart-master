...
public class KLineActivity extends Activity {
    ...
    private void initChart() {
        ...
        axisLeftK = combinedchart.getAxisLeft();//getAxisLeft
        axisLeftK.setDrawGridLines(true);
        axisLeftK.setDrawAxisLine(true);
        ...
        axisLeftK.setPosition(YAxis.YAxisLabelPosition.OUTSIDE_CHART);//OUTSIDE_CHART
        axisLeftK.enableGridDashedLine(10f, 10f, 0f);

        axisRightK = combinedchart.getAxisRight();//getAxisRight()
        ...
        axisRightK.enableGridDashedLine(10f, 10f, 0f);
        ...
        // 将K线控的滑动事件传递给交易量控件
        combinedchart.setOnChartGestureListener(new CoupleChartGestureListener(combinedchart, new Chart[]{barChart}));//new Chart[]{barChart}
       //new Chart[]{barChart}
    ...
    private void setData(DataParse mData) {
        ...
        final ViewPortHandler viewPortHandlerBar = barChart.getViewPortHandler();//返回这个图表中的各种状态，返回类型为ViewPortHandler
